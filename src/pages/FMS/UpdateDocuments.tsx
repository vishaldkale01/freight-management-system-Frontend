...
const UpdateDocuments = () => {
    ...
    const col = ['driver_id', 'driver.name', 'contactNumber', 'status', 'documentType'];
    useEffect(() => {
    ...
    useEffect(() => {
        setInitialRecords(() => {
            return rowData.filter((item: any) => {
                return (
                    item.driver_id.toString().includes(search.toLowerCase()) ||
    ...
    const header = ['driver_id',  'contactNumber', 'status', 'documentType'];
            ...
            <div className="panel mt-6">
                ...
                <div className="datatables">
                    <DataTable
                        ...
                        columns={[
                            { accessor: 'driver_id', title: 'sr.no', sortable: true },
                            { accessor: 'driver.name', title : "driver Name" ,sortable: true },
                            { accessor: 'driver.contactNumber', title : "contact numer" ,  sortable: true },
                            { accessor: 'driver.status', title: 'status', sortable: true },
                            { accessor: 'documentType', title: 'type of docu', sortable: true }, 
                        ]}
